...
apigClientFactory.newClient = function (config) {
    ...
    apigClient.uploadPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['body', 'Access-Control-Allow-Origin', 'Access-Control-Allow-Headers', 'key', 'Access-Control-Allow-Methods'], ['body']);
    ...
    apigClient.bucketFilenamePut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['filename', 'bucket', 'body', 'Access-Control-Allow-Origin', 'Access-Control-Allow-Headers', 'Access-Control-Allow-Methods'], ['body']);
