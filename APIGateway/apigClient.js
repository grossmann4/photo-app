...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://jjmuosmeb0.execute-api.us-east-1.amazonaws.com/Deploy1';
    ...
    apigClient.searchGet = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['body', 'Access-Control-Allow-Origin', 'Access-Control-Allow-Headers', 'q', 'Access-Control-Allow-Methods'], ['body']);
